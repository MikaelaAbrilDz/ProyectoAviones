...
public class PlayerControllerOnline : NetworkBehaviour
{
    ...
    [Header("Configuraciуn Partнculas - Turbo")]
    ...
    [Header("Configuraciуn Fast Turn")]
    ...
    public override void OnNetworkSpawn()
    {
        ...
        // Solo el owner inicializa la cбmara y busca otros jugadores
        InitializeCamera();
        FindOtherPlayer();
    }
    ...
    private void InitializeCamera()
    {
        if (cameraPrefab != null && camFollowed != null)
        {
            ...
            // Configurar cбmara para el jugador
    ...
    public void AtJoining(OutputChannels channel, LayerMask layerMain, LayerMask layerUI, int playerID)
    {
        ...
        // Esta funciуn parece ser para configuraciуn especнfica de splitscreen
        // La mantenemos por compatibilidad pero la funcionalidad principal estб en InitializeCamera()
        if (cameraObj != null)
        {
            foreach (var camera in cameraObj.GetComponentsInChildren<CinemachineCamera>())
            {
            ...
            // Configuraciуn de layers para crosshair y pointer
            if (cross != null)
            {
    ...
    public void TakeDamage(int damage, ulong attackerId)
    {
        ...
        // Toda la lógica va al servidor, que es la única fuente de verdad
    ...
    // Mйtodo para detener todos los humos
    ...
    public void DaсoAla()
    {
        ...
        life--;
        Debug.Log($"Daсo al ala! Vidas restantes: {life}");

    }

    [ServerRpc(RequireOwnership = false)]
    void DaсoAlaServerRpc()
    {
        life--;
        UpdateSmokeBasedOnHealthRpc();
    }

    public void DaсoCabina()
    {
        if (isDead) return;
        ...
        life -= 2;
        Debug.Log($"Daсo a la cabina! Vidas restantes: {life}");
    }

    [ServerRpc(RequireOwnership = false)]
    void DaсoCabinaServerRpc()
    {
        life -= 2;
        UpdateSmokeBasedOnHealthRpc();
    }

    // MЙTODOS DE DEBUG - Puedes llamarlos desde el Inspector
